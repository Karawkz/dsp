...
#### P(twin) = 1/125 + 1/300 = 0.011333333333333334

#### P(identical|twin) = P(identical)/P(twin) = (1/300)/0.011333333333333334 = 0.29411764705882354
...
#### Bayesian:
* Relies on posterior and  prior probabilities and likelihoods.
